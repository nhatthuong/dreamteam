...
let totalPages = 608 // 604 for all data
let count = 0
let lastFail
let failCount = 0
	...
	requestPromise(url)
		.then(html => {
			...
			for (const row of rows) {
				...
				player.rating = $(row).find('span.badge.badge-dark.rating').first().text()
				...
				const positions = []
				for (const position of Array.from($(row).find('span.position'))) {
...
let saveImages = () => {
  ...
  fs.mkdir('public/data/images/photos/5')
  fs.mkdir('public/data/images/photos/6')
  fs.mkdir('public/data/images/photos/7')
  fs.mkdir('public/data/images/photos/8')
  fs.mkdir('public/data/images/photos/9')
  fs.mkdir('public/data/images/photos/11')
  fs.mkdir('public/data/images/photos/12')
  fs.mkdir('public/data/images/photos/13')
  fs.mkdir('public/data/images/photos/14')
  fs.mkdir('public/data/images/photos/15')
  fs.mkdir('public/data/images/photos/16')
  fs.mkdir('public/data/images/photos/17')
  fs.mkdir('public/data/images/photos/18')
  fs.mkdir('public/data/images/photos/19')
  fs.mkdir('public/data/images/photos/20')
  fs.mkdir('public/data/images/photos/21')
  fs.mkdir('public/data/images/photos/22')
  fs.mkdir('public/data/images/photos/23')
  fs.mkdir('public/data/images/photos/24')
  fs.mkdir('public/data/images/photos/25')
