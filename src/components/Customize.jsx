...
export default class Customize extends React.Component {
  ...
  render() {
    ...
    if (this.props.downloadStatus === "disabled") {
      ...
      >Cần thêm đủ 11 cầu thủ để lưu/tải ảnh về</a>
      ...
      DownloadButton = <a
        title="Generate lineup"
        className="CTA"
        download="hlvbongda_dreamteam.png"
        href={this.props.downloadLink}
      >Tải ảnh về máy (PNG)</a>
    }
    return(
      <div className="Customize">
        ...
        >
          ...
          <p className="Selected">{`Chiến thuật: ${this.props.activeTacticName}`}</p>
        </div>
        <div
        ...
        >
          ...
          <p className="Selected">{`Màu Sân: ${this.state.pitchColor}`}</p>
        </div>
        {DownloadButton}
      </div>
    )
